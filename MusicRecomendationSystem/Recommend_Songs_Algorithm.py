...
unique_users_list_with_indecies = Music_Recommender_Utils.userid_index_map(unique_users_list)

#Get the mapping of song to userId set
print("Get the training data as song to user indecies")
song_to_user_index_map = Music_Recommender_Utils.song_user_map(trainingFile,
...
user_song_map_test_data = Music_Recommender_Utils.user_song_map(testingFile)
